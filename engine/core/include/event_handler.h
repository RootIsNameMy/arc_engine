...
class EventHandler : public Caller {
  ...
  static std::pair<std::vector<std::pair<EventIntFn*, void*>>, int>
      button_down_fns_;
  static std::pair<std::vector<std::pair<EventIntFn*, void*>>, int>
      button_up_fns_;
  static std::pair<std::vector<std::pair<EventDoubleDoubleFn*, void*>>, int>
      scroll_fns_;
  static std::pair<std::vector<std::pair<EventDoubleDoubleFn*, void*>>, int>
      move_fns_;

  static std::pair<std::vector<std::pair<EventIntBoolFn*, void*>>, int>
      key_down_fns_;
  ...
  static std::pair<std::vector<std::pair<EventIntIntFn*, void*>>, int>
      resize_fns_;
  static std::pair<std::vector<std::pair<EventFn*, void*>>, int> close_fns_;

  static std::pair<std::vector<std::pair<EventIntFloatFloatFn*, void*>>, int>
      touch_down_fns_;
  static std::pair<std::vector<std::pair<EventIntFloatFloatFn*, void*>>, int>
      touch_up_fns_;
  static std::pair<std::vector<std::pair<EventIntFloatFloatFn*, void*>>, int>
      touch_move_fns_;
  static std::pair<std::vector<std::pair<EventFloatFloatFloatFloatFn*, void*>>,
                   int>
      multi_gesture_fns_;

 public:
  enum Order { front, second, back };
  ...
  static void SubscribeKeyboard(KeyboardListener* listener,
                                Order order = back) {
 ...
 private:
  template <typename T>
  static void Insert(std::pair<std::vector<std::pair<T*, void*>>, int>& list,
                     void* funk, void* obj, Order order) {
  ...
  template <typename T>
  static void InitFunk(
      std::pair<std::vector<std::pair<T*, void*>>, int>& list) {
    list.first.clear();
...
//TODO: add bool parameter to call functions
