...
#ifdef ARC_PLATFORM_SDL
  SDL_Window* window =
      static_cast<SDL_Window*>(Engine::window().native_window());
  ImGui_ImplSDL2_InitForOpenGL(window, SDL_GL_GetCurrentContext());
  ImGui_ImplOpenGL3_Init("#version 300 es");
#elif ARC_PLATFORM_GLFW
  GLFWwindow* window =
      static_cast<GLFWwindow*>(Engine::window().native_window());
  ImGui_ImplGlfw_InitForOpenGL(window, true);
  ImGui_ImplOpenGL3_Init("#version 410");
#endif

  EventHandler::SubscribeKeyboard(this, EventHandler::Order::front);
  EventHandler::SubscribeMouse(this, EventHandler::Order::front);
