...
void OrthographicCamera::Setup(float screen_ratio, float zoom, float z_near,
...
void OrthographicCamera::SetProjection(float screen_ratio, float zoom,
                                       float z_near, float z_far) {
  projection_ =
      glm::ortho(-zoom * screen_ratio / 2.0f, zoom * screen_ratio / 2.0f,
                 -zoom / 2.0f, zoom / 2.0f, -100.0f, 100.0f);
  view_projection_ = projection_ * view_;
}
}  // namespace arc
