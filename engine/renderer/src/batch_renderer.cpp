...
void BatchRenderer::Init() {
  ...
  vertex_buffer_.Create(s_maxNumQuads * 4 * sizeof(Vertex));
  ...
  vertex_buffer_text_.Create(s_maxNumTextures * 4 * sizeof(VertexText));
  vertex_buffer_text_.set_layout({{ShaderDataType::Float2, "a_position"},
                                  {ShaderDataType::Float2, "a_tex_coord"},
  ...
  index_buffer_.Create(indices_, s_maxNumQuads * 6);
  vertex_array_.set_index_buffer(index_buffer_);

  index_buffer_text_.Create(indices_, s_maxNumQuads * 6);
  ...
  // shader_text_.Create("/home/martines/Desktop/git_repos/arc_engine/engine/shaders/text_shader");
  // // TODO: Fix on android
  ...
  textures_[0] = {white_texture_.GetTexture(),
...
void BatchRenderer::End() {
  ...
  //
  //        }
  //        vertex_buffer_text_.SetData(vertices_text_, num_quads_text_ * 4 *
  //        sizeof(VertexText));
  //        vertex_array_text_.set_index_buffer(index_buffer_text_);
...
void BatchRenderer::DrawTexture(const Texture &texture, const glm::vec3 &pos,
