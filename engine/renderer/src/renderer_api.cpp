...
RenderCommand::VoidMemberDrawTypeFn* RenderCommand::s_set_draw_type_fn_;
void RenderCommand::Init() {
  s_renderer_api_ = RendererAPI::Create();

  s_init_fn_ = (VoidMemberFn*)GetVTable<RendererAPI>(s_renderer_api_)[0];
  s_set_viewport_fn_ =
      (VoidMemberFnViewport*)GetVTable<RendererAPI>(s_renderer_api_)[1];
  s_set_clear_color_fn_ =
      (VoidMemberFnVec4*)GetVTable<RendererAPI>(s_renderer_api_)[2];
  s_clear_fn_ = (VoidMemberFn*)GetVTable<RendererAPI>(s_renderer_api_)[3];
  s_draw_indexed_fn_ =
      (VoidMemberVAUnIntFn*)GetVTable<RendererAPI>(s_renderer_api_)[4];
  s_set_draw_type_fn_ =
      (VoidMemberDrawTypeFn*)GetVTable<RendererAPI>(s_renderer_api_)[5];
