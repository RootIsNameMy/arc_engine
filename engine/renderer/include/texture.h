...
namespace arc{
    ...
    public:
        ...
        inline unsigned int width() const {
            return width_fn_(texture_);
        }
        inline unsigned int height() const {
            return height_fn_(texture_);
        }
        inline unsigned int depth() const {
            return depth_fn_(texture_);
        }
        inline unsigned int renderer_id() const {
            return renderer_id_fn_(texture_);
        }
