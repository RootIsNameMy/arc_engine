...
#ifndef ARC_ENGINE_OPENGL_ES_SHADER_H
#define ARC_ENGINE_OPENGL_ES_SHADER_H

#include "core.h"
#include "shader.h"

namespace arc {
    class OpenGLESShader: public ShaderClass {
    public:
        OpenGLESShader(const std::string& name, const std::string& vertex_source, const std::string& fragment_source);
        OpenGLESShader(std::string file_path);
...
#endif //ARC_ENGINE_OPENGL_ES_SHADER_H
